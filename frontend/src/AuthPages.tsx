  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        onLogin(username, data.user?.email || "", data.token || "");
      } else {
    ...
    >
      ...
      >
        ...
        >
          ...
          <StatChip label="UPTIME" value={liveStats.uptimeNum ? formatUptime(liveStats.uptimeNum) : "..."} color="var(--card-bg)" />
        </div>
      </div>
      ...
      >
        <div style={{ width: "100%", maxWidth: "420px" }}>
          ...
          <div style={{ marginBottom: "var(--space-lg, 32px)" }}>
            ...
            <p className="font-body" style={{ color: "var(--text-muted)", marginTop: "6px", fontSize: "0.9rem" }}>
          ...
          >
            ...
            >
              <p className="font-mono" style={{ fontSize: "0.68rem", color: "var(--text-muted)" }}>
          ...
          >
            <p className="font-body" style={{ fontSize: "0.88rem", color: "var(--text-muted)" }}>
              Belum punya akun?{" "}
              <button
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center", maxWidth: "440px" }}>
          ...
          <p className="font-body" style={{ color: "var(--text-muted)", marginBottom: "32px" }}>
          ...
          >
            <div style={{ color: "var(--text-muted)", marginBottom: "4px" }}>$ ndelok auth register</div>
          ...
          <button
            ...
            className="btn"
            onClick={() => onLogin(form.username, form.email, regToken)}
            style={{
              width: "100%",
              padding: "14px",
              fontSize: "1rem",
      ...
      >
        <div style={{ width: "100%", maxWidth: "420px" }}>
          ...
          <div style={{ marginBottom: "14px" }}>
            ...
            <p
              className="font-body"
              style={{ color: "var(--text-muted)", marginTop: "4px", fontSize: "0.82rem" }}
            >
