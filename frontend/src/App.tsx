    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <aside style={{ 
        ...
        <nav style={{ display: "flex", flexDirection: "column", gap: "var(--space-sm)" }}>
          ...
          <NavItem icon={<Package size={20} />} label="Plugins" />
          <NavItem icon={<Activity size={20} />} label="Deploy" />
          <NavItem icon={<FileText size={20} />} label="Explorer" />
          <NavItem icon={<Terminal size={20} />} label="Logs & Term" />
